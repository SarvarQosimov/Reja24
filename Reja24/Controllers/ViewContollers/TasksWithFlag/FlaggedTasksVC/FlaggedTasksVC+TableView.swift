...
extension FlaggedTasksVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.updateCell(
            ...
            deadline: flaggedTasks[indexPath.row].dedline!,
...
extension FlaggedTasksVC: UITableViewDelegate {
    func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        ...
        let deadline = UIContextualAction(style: .normal, title: SetLanguage.setLanguage(.setDeadline)) { [self] _, _, _ in
        ...
        let swipe = UISwipeActionsConfiguration(actions: [delete,deadline])
        
        return swipe
    }
    
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let vc = TaskDetailVC(task: flaggedTasks[indexPath.row])
